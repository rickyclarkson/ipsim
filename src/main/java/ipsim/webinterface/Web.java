...
public final class Web
{
	 ...
	 */
	public static String webInteraction(final String command,final String customerNumber,final String testNumber,final String line1,final String line2) throws IOException
	{
		Assertion.assertNotNull(command,line1,line2);
		...
		writer.println("Content-Length: "+(5+customerNumber.length()+command.length()+testNumber.length()+line1.length()+line2.length()));

		writer.println();
		writer.println(command+' '+customerNumber+' '+testNumber+' '+line1);
