    ...
    private class ProgressOptionPane extends JOptionPane {
        ...
        public JDialog createDialog(final Component parentComponent, final String title) {
            ...
            if (window instanceof SharedOwnerFrame) {
                final WindowListener ownerShutdownListener = getSharedOwnerFrameShutdownListener();
            ...
            addPropertyChangeListener(new PropertyChangeListener() {
                ...
                public void propertyChange(final PropertyChangeEvent event) {
                    if (dialog.isVisible() && event.getSource().equals(ProgressOptionPane.this) && (event.getPropertyName().equals(VALUE_PROPERTY) || event.getPropertyName().equals(INPUT_VALUE_PROPERTY))) {
    ...
    public class AccessibleProgressMonitor extends AccessibleContext implements AccessibleText, ChangeListener, PropertyChangeListener {
        ...
        public int getIndexAtPoint(final Point p) {
            ...
            if (at != null && sameWindowAncestor(pane, noteLabel)) {
                ...
                final Point noteLabelPoint = SwingUtilities.convertPoint(pane, p, noteLabel);
